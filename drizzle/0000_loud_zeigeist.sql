...
CREATE TABLE "companies" (
	...
	"phone" varchar(40),
	"primary_color" varchar(9) DEFAULT '#c9a227' NOT NULL,
	...
	"imap_last_sync" timestamp with time zone,
	"imap_last_error" text,
	"whatsapp_secret" varchar(64) NOT NULL,
...
CREATE TABLE "incidents" (
	...
	"status" varchar(12) DEFAULT 'abierta' NOT NULL,
...
CREATE TABLE "messages" (
	...
	"direction" varchar(4) DEFAULT 'in' NOT NULL,
	"sender" varchar(200) DEFAULT '' NOT NULL,
	"subject" varchar(240) DEFAULT '' NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "communities" ADD CONSTRAINT "communities_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "incidents" ADD CONSTRAINT "incidents_resident_id_residents_id_fk" FOREIGN KEY ("resident_id") REFERENCES "public"."residents"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "messages" ADD CONSTRAINT "messages_community_id_communities_id_fk" FOREIGN KEY ("community_id") REFERENCES "public"."communities"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "residents" ADD CONSTRAINT "residents_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "residents" ADD CONSTRAINT "residents_community_id_communities_id_fk" FOREIGN KEY ("community_id") REFERENCES "public"."communities"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
